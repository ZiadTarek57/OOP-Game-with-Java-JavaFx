...
//import static project.ProgrammingSemester4.folderPath;
import static project.ProgrammingSemester4.loadImage;
...
//        blackPanther.getFacingLeft().setFitHeight(2*Champion.height);
//        blackPanther.getFacingRight().setFitHeight(2*Champion.height);
//        blackPanther.getHittingLeft1().setFitHeight(2*Champion.height);
//        blackPanther.getHittingLeft2().setFitHeight(2*Champion.height);
//        blackPanther.getHittingLeft3().setFitHeight(2*Champion.height);
//        
//        blackPanther.getHittingRight1().setFitHeight(2*Champion.height);
//        blackPanther.getHittingRight2().setFitHeight(2*Champion.height);
//        blackPanther.getHittingRight3().setFitHeight(2*Champion.height);
//
//        blackPanther.getMovingLeft().setFitHeight(2*Champion.height);
//        blackPanther.getMovingRight().setFitHeight(2*Champion.height);
//        
//        
//
//        for (int i=0; i<blackPanther.getAnimatedSkins().size();i++){
//            if(i!=8 && i!=9)blackPanther.getAnimatedSkins().get(i).setY(180);
//            
//        }
//        
...
//        blackWidow.getFacingLeft().setFitHeight(1.8*Champion.height);
//        blackWidow.getFacingRight().setFitHeight(1.8*Champion.height);
//        blackWidow.getFacingLeft().setFitWidth(1.3*Champion.width);
//        blackWidow.getFacingRight().setFitWidth(1.3*Champion.width);
//        
//        blackWidow.getHittingLeft1().setFitHeight(2*Champion.height);
//        blackWidow.getHittingLeft2().setFitHeight(2*Champion.height);
//        blackWidow.getHittingLeft3().setFitHeight(2*Champion.height);
//        
//        blackWidow.getHittingRight1().setFitHeight(2*Champion.height);
//        blackWidow.getHittingRight2().setFitHeight(2*Champion.height);
//        blackWidow.getHittingRight3().setFitHeight(2*Champion.height);
//
//        blackWidow.getFacingLeft().setY(140);
//        blackWidow.getFacingRight().setY(140);
//        
//        for (int i=2; i<blackWidow.getAnimatedSkins().size()-4;i++){
//            if(i!=8 && i!=9)blackWidow.getAnimatedSkins().get(i).setY(500);
//            
//        }
