...
/*class Champion {
    ...
    private int power;
    private int speed;
    private final int musicSpecialEffect;
    private int weapon;
    private final int skin;
    private final int [] animatedSkin;
    private Point2D position;
    private double rangeHit;
    private String orientation;
    private final int skillMove;
    

    public Champion(String name,int jumpValue,int power,int speed,int musicSpecialEffect,int skin, int skillMove, 
            int [] animatedSkin){
        this.name=name;
        this.health=100;
        this.power=power;
        ...
        this.power=power;
        this.speed=speed;
        this.musicSpecialEffect=musicSpecialEffect;
        this.skin=skin;
        this.skillMove=skillMove;
        this.position=Point2D.ZERO;
        this.animatedSkin=animatedSkin;
    }
...
public class Champion {
    ...
    private String name;
    //private int jumpValue;   --- set same jump value for all w khalas
    private double health = 100;
    private int score;
    public static int highScore=0;
    private double power; //hit power
    //private int skillMovePower; // special move hit power
    ...
    //private DoubleProperty healthProperty; // initial health
    ...
    public Champion (String name, double power, double speed){
        ...
        this.speed=speed;
        this.hitRange=50;
       // this.healthProperty= new SimpleDoubleProperty(100*4);
        this.jumplock=false;
        jumpLeftLock=false;
        jumpRightLock=false;
        moveLeftLock=false;
...
//        return width;
//    }
//    public void setHealthProperty(int healthDiff) {
//        this.healthProperty.subtract(4*healthDiff);
//    }
...
//    }
    ...
    //number of seconds between each hit or move of the computer
...
public static Champion getChampion2(){
    ...
    public void setHealth(double health) {
        //int healthDiff= this.health-health;
        this.health = health;
//        System.out.println("I did access health");
//        
//        setHealthProperty(healthDiff);
    }
    ...
    void editHealth(int health){
        this.health += health;
        // to edit health after recieving a hit 
    }
...
// check with tamer
    ...
    /**
     * 
     * @param number to increment the x of all images with this number 
     */
